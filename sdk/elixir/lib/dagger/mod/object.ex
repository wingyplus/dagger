defmodule Dagger.Mod.Object do
  ...
  defmacro __before_compile__(env) do
    ...
    quote do
      unquote(Dagger.Mod.Object.Utils.fields_to_type(fields))
      unquote(Dagger.Mod.Object.Utils.fields_to_struct(fields))
      unquote(Dagger.Mod.Object.Utils.implement_decoder(fields))
      unquote(Dagger.Mod.Object.Utils.implement_encoder(fields))
    end
  end
