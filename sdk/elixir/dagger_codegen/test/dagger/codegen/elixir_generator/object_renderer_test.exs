defmodule Dagger.Codegen.ElixirGenerator.ObjectRendererTest do
  ...
  test "iss 8610" do
    auto_assert(
      ...
      defmodule Dagger.Directory do
        ...
        def with_directory(%__MODULE__{} = directory_, path, %Dagger.Directory{} = directory, optional_args \\\\ [])
  ...
  test "guard clause for required arguments" do
    auto_assert(
      """
      # This file generated by `dagger_codegen`. Please DO NOT EDIT.
      defmodule Dagger.Container do
        ...
        def with_env_variable(%__MODULE__{} = container, name, value)
        ...
        \"""
        @spec with_secret_variable(t(), Dagger.Secret.t(), String.t()) :: Dagger.Container.t()
        def with_secret_variable(%__MODULE__{} = container, %Dagger.Secret{} = secret, name) when is_binary(name) do
          query_builder =
            container.query_builder
        ...
        Set retry options.
        \"""
        @spec with_retry(t(), integer(), boolean()) :: Dagger.Container.t()
        def with_retry(%__MODULE__{} = container, count, focus)
            when is_integer(count) and is_boolean(focus) do
          query_builder =
            container.query_builder
            |> QB.select("withRetry")
            |> QB.put_arg("count", count)
            |> QB.put_arg("focus", focus)
      ...
      """ <- render_type(ObjectRenderer, "test/fixtures/objects/guard-clause.json")
    )
  end
