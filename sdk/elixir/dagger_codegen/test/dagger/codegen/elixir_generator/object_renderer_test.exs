defmodule Dagger.Codegen.ElixirGenerator.ObjectRendererTest do
  ...
  test "return list of enums" do
    auto_assert(
      ...
      """ <- render("return-list-of-enums.json")
    )
  end
  ...
  test "iss 8610" do
    auto_assert(
      ...
      """ <- render("iss-8610.json")
    )
  end

  test "code navigation" do
    auto_assert(
      """
      # This file generated by `dagger_codegen`. Please DO NOT EDIT.
      defmodule Dagger.Client do
        ...
        @spec wolfi(t()) :: Dagger.Wolfi.t()
        # wolfi (modules/wolfi/main.go:10)
        def wolfi(%__MODULE__{} = client) do
          query_builder =
            client.query_builder |> QB.select("wolfi")
  ...
  defp render(file) do
    render_type(
      ObjectRenderer,
      Path.join(["test", "fixtures", "objects", file])
    )
  end
end
