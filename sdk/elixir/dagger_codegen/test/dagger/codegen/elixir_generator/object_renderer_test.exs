defmodule Dagger.Codegen.ElixirGenerator.ObjectRendererTest do
  ...
  test "accept struct type of id argument" do
    auto_assert(
      ...
      defmodule Dagger.Client do
        ...
        def load_container_from_id(%__MODULE__{} = client, id) when is_binary(id) do
          query_builder =
  ...
  test "guard required scalar arguments" do
    auto_assert(
      """
      # This file generated by `dagger_codegen`. Please DO NOT EDIT.
      defmodule Dagger.Fixture do
        @moduledoc \"""
        A fixture to exercise guard rendering on scalar types.
        \"""

        use Dagger.Core.Base, kind: :object, name: "Fixture"
        ...
        @doc \"""
        Exercise scalar guards.
        \"""
        @spec with_all(t(), String.t(), integer(), float(), boolean()) :: Dagger.Fixture.t()
        def with_all(%__MODULE__{} = fixture, name, port, ratio, enabled)
            when is_binary(name) and is_integer(port) and is_float(ratio) and is_boolean(enabled) do
          query_builder =
            fixture.query_builder
            |> QB.select("withAll")
            |> QB.put_arg("name", name)
            |> QB.put_arg("port", port)
            |> QB.put_arg("ratio", ratio)
            |> QB.put_arg("enabled", enabled)
      ...
      """ <- render_type(ObjectRenderer, "test/fixtures/objects/guard-scalar-types.json")
    )
  end

  test "guard struct argument for id types" do
    auto_assert(
      """
      # This file generated by `dagger_codegen`. Please DO NOT EDIT.
      defmodule Dagger.Container do
        @moduledoc \"""
        A fixture that uses object/ID struct arguments.
        \"""
        ...
        @doc \"""
        Set a new environment variable from a secret.
        \"""
        @spec with_secret_variable(t(), String.t(), Dagger.Secret.t()) :: Dagger.Container.t()
        def with_secret_variable(%__MODULE__{} = container, name, %Dagger.Secret{} = secret)
      ...
      """ <- render_type(ObjectRenderer, "test/fixtures/objects/guard-struct-arg.json")
    )
  end

  test "guard list argument" do
    auto_assert(
      """
      # This file generated by `dagger_codegen`. Please DO NOT EDIT.
      defmodule Dagger.Container do
        @moduledoc \"""
        A fixture to exercise guard rendering on list arguments.
        \"""
        ...
        @doc \"""
        Exercise list guards.
        \"""
        @spec with_exec(t(), [String.t()]) :: Dagger.Container.t()
        def with_exec(%__MODULE__{} = container, args) when is_list(args) do
          query_builder = container.query_builder |> QB.select("withExec") |> QB.put_arg("args", args)
      ...
      """ <- render_type(ObjectRenderer, "test/fixtures/objects/guard-list-arg.json")
    )
  end

  test "guard enum argument" do
    auto_assert(
      """
      # This file generated by `dagger_codegen`. Please DO NOT EDIT.
      defmodule Dagger.CacheVolume do
        @moduledoc \"""
        A fixture to exercise guard rendering on enum arguments.
        \"""
        ...
        Exercise enum guard.
        \"""
        @spec with_sharing(t(), Dagger.CacheSharingMode.t()) :: Dagger.CacheVolume.t()
        def with_sharing(%__MODULE__{} = cache_volume, sharing) when is_atom(sharing) do
          query_builder =
            cache_volume.query_builder |> QB.select("withSharing") |> QB.put_arg("sharing", sharing)
      ...
      """ <- render_type(ObjectRenderer, "test/fixtures/objects/guard-enum-arg.json")
    )
  end
